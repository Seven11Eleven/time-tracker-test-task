Тестовое задание в EffectiveMobile

постарался реализовать все, возникли вопросы насчёт второго пункта и третьего с обогащенной БД. 
Я не стал реализовывать обогащение информации пользователей, т.к. я не нашел подходящие API, 
поэтому принял решение добавлять информацию об пользователе напрямую через rest api.
